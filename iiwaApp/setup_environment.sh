...
export DIRECTOR_BUILD=/home/momap/kuka-dev/director/build
export DRAKE_BASE=/home/momap/kuka-dev/drake
export LD_LIBRARY_PATH=$PWD/install/lib:$DRAKE_BASE/build/install/lib
export PYTHONPATH=$DIRECTOR_BUILD/install/lib/python2.7/dist-packages:$DRAKE_BASE/build/install/lib/python2.7/dist-packages:$PYTHONPATH


alias makedirector='make -C $DIRECTOR_BUILD/src/director-build install'
alias runprocman='$DRAKE_BASE/build/install/bin/bot-procman-sheriff -l iiwa_hardware_draper.pmd'
